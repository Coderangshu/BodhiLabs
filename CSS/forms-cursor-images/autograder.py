...
combined_data += run_autograder("forms", "autograder-forms.py")
combined_data += run_autograder("cursor", "autograder-cursor.py")
combined_data += run_autograder("images", "autograder-images.py")
