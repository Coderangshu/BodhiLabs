...
STYLE_FILE = "/home/labDirectory/cursor/style.css"
EXPECTED_FILE = os.path.join(os.path.dirname(__file__), "jsons", "cursor.json")
    ...
    for rule in rules:
        ...
        for decl in declarations:
            if decl.type == "declaration":
                props[decl.name.strip().lower()] = tinycss2.serialize(decl.value).strip().lower()
...
eval_path = os.path.join(os.path.dirname(__file__), "evaluate.json")
